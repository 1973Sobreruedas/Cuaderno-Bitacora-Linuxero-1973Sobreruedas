...
> ![última_actualización](https://img.shields.io/badge/Última_Actualización_del_README-06_·_jul_·_2026-slateblue?style=plastic&logo=datefns&logoColor=wheat)
...
Comparto propuestas, recursos, *scripts* y documentación nacidos de la experiencia, siempre desde mi propia forma de vivir y entender el mundo **GNU/Linux**.

Este **Cuaderno** no busca ser enciclopédico. Busca ser real, útil y, sobre todo, humano. Cercano y abierto, donde la comunidad linuxera pueda saludar o contactar por diferentes motivos [desde aquí](https://www.manualdesupervivencialinux.com/cuaderno/).

---

## Definición del proyecto

Este **Cuaderno de Bitácora Linuxero** forma parte del proyecto [Manual de Supervivencia Linux](https://www.manualdesupervivenciaLinux.com), aquí estás en el repositorio que contiene diferentes recursos para **GNU/Linux**, documentación, propuestas, *scripts* y trucos de supervivencia destinados a facilitar la vida de los usuarios de **GNU/Linux**, todo de creación propia.

Comparto mi trabajo práctico mediante programas, utilidades, automatizaciones, documentación y recursos para **GNU/Linux** en un espacio multiplataforma.

*Scripts* sencillos y de dificultad moderada basados en la filosofía KISS. A excepción de aquellos *scripts* que adquieren entidad propia y buscan su espacio personal como me ocurre con mi `conversor-MKV.sh` que ha ido evolucionando.

Todo ello con un enfoque orientado a quienes comienzan en Linux y también a quienes, tras años utilizando una o varias distribuciones, desean comprender mejor los procesos e intensificar el uso de la Terminal.

En definitiva, es un proyecto vivo y en expansión.

### Manual de Supervivencia Linux

![GNU/Linux](https://img.shields.io/badge/GNU/Linux-Multiplataforma-wheat?logo=linux&logoColor=black) 
![Linux Mint](https://img.shields.io/badge/Linux_Mint-MATE-87CF3E?logo=linuxmint&logoColor=white)

**MSL** se centra principalmente en el ecosistema **Linux Mint MATE**; también en el conocimiento y uso de comandos de **GNU/Linux** (multiplataforma) desde una perspectiva más teórica con ejemplos funcionales y documentados.

### Cuaderno de Bitácora Linuxero

![Bash](https://img.shields.io/badge/Bash-Shell-4EAA25?logo=gnubash&logoColor=wheat)

**CBL**, reúne la parte práctica del proyecto mediante un repositorio donde se alojan:
...
- Compartir conocimientos útiles para la comunidad GNU/Linux.
- Desarrollar herramientas y recursos prácticos.
- Documentar experiencias reales y soluciones propias.
- Mantener un repositorio vivo, abierto y en constante evolución.
